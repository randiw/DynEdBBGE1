package com.randi.dyned.view.manager;
...
import com.awan.dyned.general.Constans;
import com.awan.dyned.general.GeneralFunction;
import com.randi.dyned.MainApp;
import com.randi.dyned.model.GrammarManager;
import com.randi.dyned.model.LessonItem;
import com.randi.dyned.model.Variables;
import com.randi.dyned.model.connector.StatisticConnector;
import com.randi.dyned.model.persistable.AvatarManager;
import com.randi.dyned.model.persistable.EducationManager;
import com.randi.dyned.model.persistable.NotificationManager;
import com.randi.dyned.model.persistable.SessionManager;
import com.randi.dyned.tools.FontSetting;
import com.randi.dyned.view.AvatarScreen;
import com.randi.dyned.view.HomeMenuScreen;
import com.randi.dyned.view.field.CustomImageButtonField;
import com.randi.dyned.view.field.GreyLabelField;
