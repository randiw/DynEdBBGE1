...
public class Variables {
	...
	public static final String CONVERSATION_CODE = "GE1";
	public static final String APP_NAME = "General English 1";
	public static final String APP_ID = "100001";

	public static final String SPLASH_NAME = "General English / 1";
